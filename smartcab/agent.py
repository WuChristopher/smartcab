...
class LearningAgent(Agent):
    ...
    def build_state(self):
        ...
        # if waypoint == 'forward' and inputs['oncoming'] == None:
        #     state = (waypoint, inputs['light'], 'empty')
        # elif waypoint == 'left' and inputs['left'] == None:
        #     state = (waypoint, inputs['light'], 'empty')
        # elif waypoint == 'right' and inputs['right'] == None:
        #     state = (waypoint, inputs['light'], 'empty')
        # else:
        #     state = (waypoint, inputs['light'], 'nonempty')
...
def run():
    ...
    sim = Simulator(env, update_delay=.01, display=False, log_metrics=False, optimized=True)
